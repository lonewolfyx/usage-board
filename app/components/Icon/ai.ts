const logos = {
    ...
    codebuff: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Codebuff</title><rect width="24" height="24" rx="6" fill="#14B8A6"/><path d="M8 7.5h5.25a3.75 3.75 0 1 1 0 7.5H8z" fill="#fff"/><path d="M9.75 11.25h4.25a1.75 1.75 0 0 1 0 3.5H9.75z" fill="#14B8A6"/></svg>',
    ...
    droid: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Droid</title><rect width="24" height="24" rx="6" fill="#06B6D4"/><path d="M8.5 9.5h7a2.5 2.5 0 0 1 2.5 2.5v3.5h-12V12a2.5 2.5 0 0 1 2.5-2.5Z" fill="#fff"/><path d="M9 7.5l1-1.5M15 7.5l-1-1.5" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/><circle cx="10" cy="12.5" r="0.8" fill="#06B6D4"/><circle cx="14" cy="12.5" r="0.8" fill="#06B6D4"/></svg>',
    ...
    goose: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Goose</title><rect width="24" height="24" rx="6" fill="#22C55E"/><path d="M7.5 13.25c0-3.452 2.25-5.75 5-5.75 1.867 0 4 1.262 4 3.25 0 1.326-.84 2.139-2 2.75l-2.75 1.5c-.69.376-1.111.88-1.25 1.5H8.75c.167-1.47.95-2.604 2.25-3.33l2.62-1.46c.77-.431 1.13-.79 1.13-1.46 0-.78-.83-1.33-1.87-1.33-1.72 0-3.13 1.41-3.13 4.33Z" fill="#fff"/></svg>',
    hermes: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Hermes</title><rect width="24" height="24" rx="6" fill="#8B5CF6"/><path d="M8 7h2v4h4V7h2v10h-2v-4h-4v4H8z" fill="#fff"/></svg>',
    ...
    kilo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Kilo</title><rect width="24" height="24" rx="6" fill="#F97316"/><path d="M8 7h2v4.15L13.75 7H16l-4.2 4.65L16.25 17h-2.5L10 12.45V17H8z" fill="#fff"/></svg>',
    openclaw: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>OpenClaw</title><rect width="24" height="24" rx="6" fill="#EC4899"/><path d="M8.75 8.5c0-1.1.9-2 2-2 .93 0 1.72.64 1.94 1.5h.62a2 2 0 1 1 1.94 2.5H14.5V17h-2v-6H11a2.25 2.25 0 0 1-2.25-2.25V8.5Z" fill="#fff"/></svg>',
    ...
    pi: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><title>Pi</title><rect width="24" height="24" rx="6" fill="#A855F7"/><path d="M8.5 7h7v2h-2v8h-2V9h-3z" fill="#fff"/></svg>',
